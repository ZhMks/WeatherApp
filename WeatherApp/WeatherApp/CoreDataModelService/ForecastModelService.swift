...
final class ForecastModelService {
    ...
    func convertSpeedValues() {
        guard let value = UserDefaults.standard.value(forKey: "distance") as? String else { return }
    ...
    func convertTempValues() {
        ...
        guard let value = UserDefaults.standard.value(forKey: "temperature") as? String else { return }
    ...
    func convertHourFormat() {
        guard let value = UserDefaults.standard.value(forKey: "time") as? String else { return }
